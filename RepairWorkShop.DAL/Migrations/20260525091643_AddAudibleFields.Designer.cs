...
namespace RepairWorkShop.DAL.Migrations
{
    ...
    [Migration("20260525091643_AddAudibleFields")]
    partial class AddAudibleFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.ServiceTask", b =>
                {
                    ...
                    b.Property<string>("DiagnosticsResult")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.CustomerRequest", b =>
                {
                    ...
                    b.HasOne("RepairWorkShop.DAL.Entities.User", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.RolePermission", b =>
                {
                    b.HasOne("RepairWorkShop.DAL.Entities.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RepairWorkShop.DAL.Entities.UserRole", "UserRole")
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.ServiceTask", b =>
                {
                    ...
                    b.HasOne("RepairWorkShop.DAL.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("RepairWorkShop.DAL.Entities.User", b =>
                {
                    b.HasOne("RepairWorkShop.DAL.Entities.UserRole", "Role")
                        .WithMany()
